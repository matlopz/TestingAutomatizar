...
public class despegar_AutomatedTest {
	...
	//calendario
	By calendarioEntraLocator = By.xpath("//div[@class='sbox5-floating-tooltip sbox5-floating-tooltip-opened']//div[@class='sbox5-monthgrid'][@data-month='2022-02']//div[@class='sbox5-monthgrid-datenumber-number'][text()='24']");
	...
	@Test(description = "VALIDAR ALOJAMIENTO EN DESPEGAR FUNCIONA")
  public void despegar() throws InterruptedException {
	    ...
	    driver.findElement(alojamienteolocator).click();
		  ...
		  driver.findElement(igresoCiudadlocator).sendKeys("Villa Carlos Paz, Córdoba, Argentina");
		  Thread.sleep(3000);
  ...
  public void alojamienteo() throws InterruptedException {
